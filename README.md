# The context
El Salvador's Ministry of Finance (Ministerio de Hacienda) set June 1, 2026 as the deadline for all taxpayers to migrate to electronic invoicing (DTE). The problem is asymmetric:

Large and mid-sized companies have already migrated — they have in-house accountants and budgets for ERPs.
